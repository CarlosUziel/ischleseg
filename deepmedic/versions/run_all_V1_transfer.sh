...
../deepMedicRun -dev cuda -model ./DM_V1_transfer_0/output/cnnModels/trainSession/*final*.save -test ./DM_V1_transfer_0/configFiles/validation/valConfig.cfg 
...
../deepMedicRun -dev cuda -model ./DM_V1_transfer_1/output/cnnModels/trainSession/*final*.save -test ./DM_V1_transfer_1/configFiles/validation/valConfig.cfg 
...
../deepMedicRun -dev cuda -model ./DM_V1_transfer_2/output/cnnModels/trainSession/*final*.save -test ./DM_V1_transfer_2/configFiles/validation/valConfig.cfg 
...
../deepMedicRun -dev cuda -model ./DM_V1_transfer_3/output/cnnModels/trainSession/*final*.save -test ./DM_V1_transfer_3/configFiles/validation/valConfig.cfg 
...
../deepMedicRun -dev cuda -model ./DM_V1_transfer_4/output/cnnModels/trainSession/*final*.save -test ./DM_V1_transfer_4/configFiles/validation/valConfig.cfg 
