...
../deepMedicRun -dev cuda -model ./DM_V1_R_0/output/cnnModels/trainSession/*final*.save -test ./DM_V1_R_0/configFiles/validation/valConfig.cfg 
...
../deepMedicRun -dev cuda -model ./DM_V1_R_1/output/cnnModels/trainSession/*final*.save -test ./DM_V1_R_1/configFiles/validation/valConfig.cfg 
...
../deepMedicRun -dev cuda -model ./DM_V1_R_2/output/cnnModels/trainSession/*final*.save -test ./DM_V1_R_2/configFiles/validation/valConfig.cfg 
...
../deepMedicRun -dev cuda -model ./DM_V1_R_3/output/cnnModels/trainSession/*final*.save -test ./DM_V1_R_3/configFiles/validation/valConfig.cfg 
...
../deepMedicRun -dev cuda -model ./DM_V1_R_4/output/cnnModels/trainSession/*final*.save -test ./DM_V1_R_4/configFiles/validation/valConfig.cfg 
